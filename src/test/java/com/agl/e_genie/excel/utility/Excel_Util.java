package com.agl.e_genie.excel.utility;
...
//		Collection<Object[]> dataProvider=new ArrayList<Object[]>();
	...
	public  List<Integer> getRowNumbers(Sheet sheetObj ,String testcaseId) throws IOException {
		...
		int columnnum =getColumnNumber(sheetObj,"TestCaseName");
...
public static void main(String[] args) throws IOException {
	...
	List<Map<String,String>> data=	excel.getTestCaseData("src\\test\\resources\\TestCaseData.xlsx", "Apply_Campaign_Filter");
	
	for(int i=0;i<=data.size()-1;i++) {
		Map<String,String> dataMap=data.get(i);
		String exHomePg=dataMap.get("ExpSaveSearchChechbox");
		System.out.println("Fatching data from the excel sheet : "+ exHomePg);
	}
